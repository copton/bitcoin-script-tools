...
goodCases = [
  ...
  , ("OP_PUSHDATA 1 0x23", [CmdOpcode $ OP_PUSHDATA Direct (0x23)])
  , ("PUSHDATA 1 0x23", [CmdOpcode $ OP_PUSHDATA Direct (0x23)])
  , ("op_pushdata 1 0x23", [CmdOpcode $ OP_PUSHDATA Direct (0x23)])
  , ("pushdata 1 0x23", [CmdOpcode $ OP_PUSHDATA Direct (0x23)])
  , ("OP_PUSHDATA 1 0x23", [CmdOpcode $ OP_PUSHDATA Direct (0x23)])
  , ("OP_PUSHDATA1 6 0x040815162342", [CmdOpcode $ OP_PUSHDATA OneByte (0x40815162342)])
  , ("OP_PUSHDATA2 6 0x040815162342", [CmdOpcode $ OP_PUSHDATA TwoBytes (0x40815162342)])
  , ("OP_PUSHDATA4 6 0x040815162342", [CmdOpcode $ OP_PUSHDATA FourBytes (0x40815162342)])
