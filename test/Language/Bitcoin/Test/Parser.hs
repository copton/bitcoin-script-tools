...
goodCases = [
  ...
  , ("OP_PUSHDATA 1 0x23", [CmdOpcode $ OP_PUSHDATA Implicit 1 0x23])
  , ("PUSHDATA 1 0x23", [CmdOpcode $ OP_PUSHDATA Implicit 1 0x23])
  , ("op_pushdata 1 0x23", [CmdOpcode $ OP_PUSHDATA Implicit 1 0x23])
  , ("pushdata 1 0x23", [CmdOpcode $ OP_PUSHDATA Implicit 1 0x23])
  , ("OP_PUSHDATA 1 0x23", [CmdOpcode $ OP_PUSHDATA Implicit 1 0x23])
  , ("OP_PUSHDATA1 6 0x040815162342", [CmdOpcode $ OP_PUSHDATA OneByte 6 0x40815162342])
  , ("OP_PUSHDATA2 6 0x040815162342", [CmdOpcode $ OP_PUSHDATA TwoBytes 6 0x40815162342])
  , ("OP_PUSHDATA4 6 0x040815162342", [CmdOpcode $ OP_PUSHDATA FourBytes 6 0x40815162342])
  , ("DATA 0x40815162342", [DATA 0x40815162342])
  , ("data 40815162342", [DATA 40815162342])
  , ("KEY 1", [KEY 1])
  , ("key 1", [KEY 1])
  , ("SIG 1", [SIG 1])
  , ("sig 1", [SIG 1])
